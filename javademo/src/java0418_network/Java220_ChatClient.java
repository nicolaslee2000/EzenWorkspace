...
public class Java220_ChatClient implements Runnable, ActionListener {
	String host;
	int port;
	String userName;
	private JFrame frm;
	...
	public Java220_ChatClient(String host, int port) {
		this.port = port;
		this.host = host;
	...
	public static void main(String[] args) {
		Java220_ChatClient client = new Java220_ChatClient("127.0.0.1", 5000);
		client.initStart();
